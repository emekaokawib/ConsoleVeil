...
const contractABI = require("../artifacts/contracts/Consoleveil.sol/Consoleveil.json").abi;

program
    .name("consoleveil-cli")
    .description("CLI tool for Consoleveil smart contract")
    .version("1.0.0");
